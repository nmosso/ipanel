...
//export const FASTAPI_URL: string = environment.fastAPI;
...
export const ENDPOINTS = {
  ...
  col_clientexists: '/v3/partner/clientexists',  //
  clients:'/v3/clients',  //
  devices: '/v3/devices',  //
  brands: '/v3/brands',  //
  stats: '/v3/stats',  //
  ...
  astra: '/v3/astra',  //getchannelsinfo


  dashboard: '/v3/dashboard', //xClient 
