...
//      { path: 'clientsz', loadChildren: () => import('./components/clients/clients.module').then(m => m.ClientsModule) },
...
/*       { path: 'livechannels', loadChildren: () => import('./components/livechannels/livechannels.module').then(m => m.LivechannelsModule) },
      { path: 'fastchannels', loadChildren: () => import('./components/fastchannels/fastchannels.module').then(m => m.FastchannelsModule) },
      ...
      { path: 'videos/:channelid', loadChildren: () => import('./components/videos/videos.module').then(m => m.VideosModule) },      
      { path: 'movies', loadChildren: () => import('./components/movies/movies.module').then(m => m.MoviesModule) },  
      { path: 'tvshows', loadChildren: () => import('./components/tvshows/tvshows.module').then(m => m.TvshowsModule) },   */
